      ...
      <div className={`sticky z-10 ${props.page === 'search' ? 'flex' : 'hidden'} lg:flex top-0  items-center justify-between px-2 py-2 bg-[#000000]`}>
        <div className={`w-full lg:w-fit flex items-center justify-between gap-2 px-1`}>
          <div className="text-xl flex items-center justify-between gap-2">
            ...
            <span className={`cursor-pointer ${canGoForward ? 'text-white font-bold' : 'text-[#a7a7a7]'}`} onClick={() => {
              navigate(1);
...

          {
            props.page === 'search' && <div className="relative group">
              <div className="absolute inset-y-0 start-0 flex items-center ps-2 sm:ps-3 ">
              ...
              <input type="search" className="max-w-[400px] shrink block p-3 ps-8 sm:ps-10 text-sm  border border-gray-900 focus:border-gray-50 hover:border-gray-600 rounded-[24px] bg-[#242424] text-gray-50 placeholder:text-[#a7a7a7] placeholder:text-[12px]" placeholder="What do you want to listen..." onChange={(ele) => {
